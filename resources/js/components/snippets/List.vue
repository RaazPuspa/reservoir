                    ...
                    <div class="flex items-center border-b border-gray-200 pb-4">
                        <div class="flex items-center justify-between w-full">
                            ...
                            <div class="flex items-center justify-end gap-x-3">
                                ...
                                <confirm @confirmed="deleteSnippet(snippet)">
                                    <template #trigger>
                                        <button class="cursor-pointer focus:outline-none text-red-500 hover:text-red-800 focus:text-red-800">
                                            <svg width="28"
                                                 height="28"
                                                 fill="none"
                                                 viewBox="0 0 24 24"
                                    ...
                                    <template #default>
                                        <div class="text-lg text-gray-900 whitespace-wrap">
                                            {{ `Are you sure to delete snippet with title: ${snippet.title}?` }}
                                        </div>
                                    </template>
                                </confirm>
                            </div>
